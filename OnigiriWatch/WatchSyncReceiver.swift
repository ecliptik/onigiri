...
final class WatchSyncReceiver: NSObject, WCSessionDelegate {
    ...
    private static func complicationFingerprint() -> Int {
        ...
        // The burn correction moves every complication's budget with no
        // Health sample behind it — without this, an accepted correction
        // reached the wrist's app but not its face until the next poll.
        hasher.combine(SharedStore.burnCorrectionKcal)
