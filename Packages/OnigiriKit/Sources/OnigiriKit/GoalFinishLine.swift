...
/// the sustained basis. On 2026-08-14 a morning reading just under the
/// target produced both at once — an orange "Target must be below your
/// current weight." beside a full progress bar reading more lost than
/// there was to lose, beside a projection promising the target in five
/// days, and no celebration anywhere, because the seven-day basis was
...
/// reaching one target and deciding on a lower one. The re-stamp moved the
/// start to today's raw weigh-in and re-zeroed a full bar —
