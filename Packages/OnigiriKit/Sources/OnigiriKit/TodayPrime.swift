...
public struct TodayPrime: Codable, Sendable, Equatable {
    ...
    /// How much of `dayBurnKcal` was the burn correction, so a primed
    /// Details card still adds up. Optional so a prime written before
    /// the correction existed decodes (as none).
    public var burnCorrectionKcal: Double?
    ...
    public init(
        ...
        self.burnCorrectionKcal = burnCorrectionKcal
