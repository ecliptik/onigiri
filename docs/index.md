...
<!-- This page mirrors the repo README (paths adjusted for the site).
     When the README changes, update this page to match. -->
...
**[User Guide](https://ecliptik.github.io/onigiri/guide/)** · **[Privacy Policy](https://ecliptik.github.io/onigiri/privacy/)** · **[Wiki](https://github.com/ecliptik/onigiri/wiki)** · **[Source](https://github.com/ecliptik/onigiri)**

**Built 100% agentically with [Claude Code](https://claude.com/claude-code).**

<p align="center">
  <img src="showcase/light/today.png" width="300" alt="The Today screen: calorie balance headline, sodium and water, the daily goal gauge, energy meters, and the log">
</p>
...
| Foods | Goal | Calendar |
|---|---|---|
| <img src="showcase/light/foods.png" width="260" alt="Food library with meals and foods"> | <img src="showcase/light/goal.png" width="260" alt="Goal: weight trend with projection and the daily plan"> | <img src="showcase/light/calendar.png" width="260" alt="Calendar: month grid of earned onigiri and streaks"> |

### iPad

<p align="center">
  <img src="showcase/light/ipad-landscape.png" width="640" alt="Today on iPad: sidebar navigation with the day summary and the log side by side">
</p>

### Apple Watch

<p align="center">
  <img src="showcase/watch/home.png" width="240" alt="Apple Watch: balance headline with a one-tap Log button and Log water">
</p>

### Home Screen widget

<p align="center">
  <img src="showcase/widget/home-screen.png" width="300" alt="The medium Today widget on the Home Screen — calorie ring, burned and eaten, sodium and water, and a Log button — beside the stock iOS widgets">
</p>
...
See [plans/PLAN.md](https://github.com/ecliptik/onigiri/blob/main/plans/PLAN.md) for the full design and roadmap.
...
[PolyForm Noncommercial 1.0.0](https://github.com/ecliptik/onigiri/blob/main/LICENSE) — read it, build it, modify it,
...
(see [CONTRIBUTING.md](https://github.com/ecliptik/onigiri/blob/main/CONTRIBUTING.md)).
