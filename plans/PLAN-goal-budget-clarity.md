...
whose header is a third use of the word "budget" (illustrative figures,
same shape):

    DAILY PLAN
      Based on              7-day average ›   ← control
      Weight used                  191.9 lb   ← its result
      To lose                        1.9 lb   ← weight − target
      Deficit needed          299 kcal/day    ← (1.9 × 3500) ÷ days left
      Average daily burn    ≈ 2,500 kcal/day  ← Health's recent average
      Budget, average day   ≈ 2,201 kcal/day  ← 2,500 − 299
      Budget, today             1,601 kcal    ← today's OWN burn − 299
      Total deficit        N kcal ≈ N lb      ← retrospective
      Last 30 days     −N predicted / −N      ← retrospective
      (footer) Daily budget grows as active energy increases.

    CALORIE BUDGET
      Resting burn, full day ≈ 1,800 kcal/day
...
3. **The two budgets are adjacent, similarly named, differently
   united** (`kcal/day` vs `kcal`) and hundreds of kcal apart. Adjacency invites
...
- **Both budgets stay, and stay distinguishable.** One label over two
  numbers is exactly the 2026-08-02 failure: Goal and
  Details were hundreds of kcal apart at lunchtime, both correct. This plan
