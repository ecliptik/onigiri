...
A2 was deferred until A1 had shown, over a few weeks of real data,
whether the gap is large and steady enough to be worth acting on. It
has: on 2026-09-22 the gap measured about the size of the budget's own
built-in deficit, and **A2 is resumed in `PLAN-burn-correction.md`** —
which also supersedes A2's "never retroactive" guardrail, with the
argument set out there. A3 stays rejected, there and here.
...
### Now
    ...
    Today
      Budget    600 / 1500 kcal
      Burn            2000 kcal

The compound `600 / 1500` asks the reader to do the subtraction, and
which side is which is not self-evident.

### Proposed

    Budget
      Today's Budget   1,500 kcal
      Eaten Today        600 kcal
