...
- **Milestones**, **progress bar**, **pace as a choice** — all three,
  ...
  - Milestones are named by PROGRESS ("15 lb down"), not by weight.
    Anchored to the start, a 193.4 lb journey would otherwise post
    marks at 188.4 and 183.4. The chart draws every rung and labels
...
start → now → target, with "N of M lb". Reads at a glance in a way
the chart doesn't. Needs the same start point.

### 5. Pace as a choice

"At this pace: <date range>. With 100 kcal/day more: <earlier range>." Turns a
