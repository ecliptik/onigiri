...
Personal-use calorie/sodium/water tracker for iPhone + Apple Watch. Goal: weight loss, driven by a visible daily energy balance.
...
- **Budget:** pounds to lose × 3,500 kcal/lb. Required daily deficit = remaining kcal ÷ days to target date. Daily budget = expected TDEE (14-day average total burn from HealthKit) − required deficit.
