...
32. **Deficit/surplus vocabulary**: Today shows "+N balance"
    (orange), Calendar "N deficit" (green), Details a row labeled
    ...
    Onigiri-only ("Nothing logged this day." under a non-zero kcal headline);
...
2. **Today scale trend line** — goal card caption "Scale: down N lb
